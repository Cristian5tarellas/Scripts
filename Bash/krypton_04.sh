...
# Year: 2023
# Explanation script:
# This script will figure out the password for level 5 of krypton wargame in Overthewire
# https://overthewire.org/wargames/
# The level contains three files, the frequency of letters in these files is the key to 
# know the key that will decrypt the code save in the file krypton5
...
function help_panel(){
  ...
  echo -e "${grayColour}The script $0 will determine the key for decrypting the password of the level krypton 5 in Overthewire. The script shows the steps of the process.${endColour}"
  ...
  echo -e "\t${blueColour}[+]${endColour}${grayColour} krypton5${endColour}"
}
...
echo -e "The maximum value of coincident letters will correspond to the length of the key"
max_length=10
